    ...
    for (let row = 0; row < 8; row++) {
        for (let col = 0; col < 8; col++) {
            ...
            if (piece) {
                ...
                if (piece.match(/[♙♖♘♗♕♔]/)) { // Pokud je figura bílá
                    pieceElement.classList.add('white-piece'); // Přidáme třídu pro bílé figurky
                } else if (piece.match(/[♟♜♞♝♛♚]/)) { // Pokud je figura černá
                    pieceElement.classList.add('black-piece'); // Přidáme třídu pro černé figurky
                }
